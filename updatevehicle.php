...
for($j=0; $j<$rows; ++$j){
	...
	Driver ID: <input type='text' name='DriverID' value='$row[DriverID]'><br>
...
if(isset($_POST['update'])){
	...
	$query = "update vehicle set DriverID='$DriverID',LicensePlate='$LP', Make='$make', Model='$model', Color='$color', Year='$year' where VehicleID = $VehicleID ";
