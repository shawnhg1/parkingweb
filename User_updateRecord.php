...
if(isset($_POST['update'])){
	...
	$query = "update driver set FirstName='$fn', LastName='$ln', Address='$address', email='$email', Username='$username', Password_='$token' where DriverID = $driverID";
